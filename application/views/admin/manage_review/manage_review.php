        ...
        <div class="card-header py-3">
            <div class="row align-items-center m-0">
                <div class="col-md-4 col-12 me-auto mb-md-0 mb-3">
                    <a href="<?= base_url('admin/review_form/') ?>">
                                ...
                                <tr class='main_block' main_id="<?= $row['id'] ?>">
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-3 fs-6">
                                            ...
                                            <a href="<?= base_url('admin/review_form/' . $row['id']) ?>" class="text-warning" data-bs-toggle="tooltip" data-bs-placement="bottom" title="" data-bs-original-title="Edit info" aria-label="Edit"><i class="bi bi-pencil-fill"></i></a>
