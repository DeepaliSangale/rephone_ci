                ...
                <div class="card-body">
                    <form id="forms" method="post" action="<?= base_url('admin/submit_product') ?>">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <select class="form-select mb-3 multiple-select" name="p_m_id[]" id="sel_model" required multiple="multiple">
                            <option value="">--Select--</option>
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <select class="form-select mb-3 single-select" name="p_variant_id" required>
                                <?php
