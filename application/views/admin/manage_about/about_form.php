...
<main class="page-content">
    ...
    <div class="row">
        <div class="col-xl-12 mx-auto">
            <div class="card">
                <div class="card-body">
                    <form id="forms" method="post" action="<?= base_url('admin/submit_about') ?>">
                        <input type="hidden" name="id" value="<?= (isset($about_data)) ?$about_data->id : '' ?>">
                       
                        <div class="mb-3 col-md-12">
                            <label class="form-label">Description</label>
                            <textarea id="editor" type="text" class="form-control inputs" rows="10" cols="80" 
                                   name="about"><?= (isset($about_data)) ?$about_data->about : '' ?></textarea>
