                                ...
                                <tr class='main_block' main_id="<?= $row['id'] ?>">
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-3 fs-6">
                                            ...
                                            <a href="<?= base_url('admin/order_form/' . $row['id']) ?>" class="text-warning" data-bs-toggle="tooltip" data-bs-placement="bottom" title="" data-bs-original-title="View detail" aria-label="views"><i class="bi bi-eye-fill"></i></a>
