<input type="hidden" id="product_id" value="<?= $product_data->p_id ?>">
 ...
 <!-- main start here----------------------------->
 <main class="page-content" id="mainWindow">
         <section class="mt-30 mb-50">
            <div class="card container">
               <div class="row">
                  <div class="col-lg-8">
                     <!-----Queastion Yes No Window------------------------------------>   
                     <?php if(!empty($tellus_qsn)){ ?>
                     <div class="row border border-radius-10" id="QuestionWindow">
                        <h6 class="text-center mt-30">Tell us a few things about your device!</h6>
                        <?php $i=1; foreach($tellus_qsn as $val){ ?>
                        <div class="row">
                            <div class="col-lg-12 mt-30">
                                <h6 class="font16-14"><?= $i++ ?>.<?= $val['qsn_name'] ?></h6>
                                <p class="p-10 text-muted"><?= $val['qsn_desc'] ?></p>
                                <div class="form-check form-check-inline radi-btn">
									<input class="form-check-input cb" type="radio" name="btnradio<?= $val['id'] ?>" data-name="<?= $val['yes_checked_value'] ?>" data-id="<?= $val['id'] ?>" value="Yes" id="btnradio_yes_<?= $val['id'] ?>">
									<label class="form-check-label" for="btnradio_yes_<?= $val['id'] ?>">Yes</label>
                               </div>
                                <div class="form-check form-check-inline radi-btn"> 
                                    <input class="form-check-input cb" type="radio" name="btnradio<?= $val['id'] ?>" data-name="<?= $val['no_checked_value'] ?>" data-id="<?= $val['id'] ?>" value="No" id="btnradio_no_<?= $val['id'] ?>">
									<label class="form-check-label" for="btnradio_no_<?= $val['id'] ?>">No</label>
								</div>
                        ...
                        <div class="row">
                           ...
                           <div class="col-lg-4">
                              <span  class="btn btn-success text-center hover-up mb-10 d-block rounded mx-auto" onclick="validate_qsn_form(<?= $val['id'] ?>);">Continue <i class="fi-rs-arrow-right"></i></span>
                           </div>
                           <div class="col-lg-4"></div>
                        </div>
                     </div>
                     ...
                     <!----//Queastion Yes No Window----------------------------------->  
                      ...
                      <!----Screen Condition-----------------------------------> 
                      <div class="row border border-radius-10" id="ScreenCondWindow" style="display:none;">
                        ...
                        <div class="row">
                           ...
                           <div class="col-lg-3 col-md-3 col-6 col-sm-4">  <span  class="btn btn-primary text-center hover-up mb-10 d-block rounded mx-auto" onclick="tellus_back();"><i class="fi-rs-arrow-left"></i>Back </span></div>
                           <div class="col-lg-3 col-md-3 col-6 col-sm-4">
                              <span  class="btn btn-success text-center hover-up mb-10 d-block rounded mx-auto" onclick="body_problem();">Continue <i class="fi-rs-arrow-right"></i></span>
                           </div>
                        </div>
                     </div>
                     <!----//Screen Condition-----------------------------------------------> 
                     ...
                     <div class="row product-grid-3 border border-radius-10" id="BodyCondWindow" style="display:none;">
                       ...
                       <?php if(!empty($bd_qsn_bplc)){ ?>
                        ...
                        <div class="row">
                           <div class="col-3 d-none d-lg-block"></div>
                           <div class="col-lg-3 col-md-3 col-6 col-sm-4">  
                              <span  class="btn btn-primary text-center hover-up mb-10 d-block rounded mx-auto" onclick="body_back();"><i class="fi-rs-arrow-left"></i>Back </span></div>
                           <div class="col-lg-3 col-md-3 col-6 col-sm-4">
                              <span  class="btn btn-success text-center hover-up mb-10 d-block rounded mx-auto" onclick="functional_problem();">Continue <i class="fi-rs-arrow-right"></i></span>
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="row product-grid-3 border border-radius-10" id="TellWindow" style="display:none;">
                        <h6 class="text-center mt-30">Functional or Physical Problems</h6>
                        ...
                        <div class="row">
                           ...
                           <div class="col-lg-3 col-md-3 col-6 col-sm-4">  <span  class="btn btn-primary text-center hover-up mb-10 d-block rounded mx-auto" onclick="tellus_back();"><i class="fi-rs-arrow-left"></i>Back </span></div>
                           <div class="col-lg-3 col-md-3 col-6 col-sm-4">
                              <span  class="btn btn-success text-center hover-up mb-10 d-block rounded mx-auto" onclick="doyou_have();">Continue <i class="fi-rs-arrow-right"></i></span>
                           </div>
                        </div>
                     </div>
                     <!----//Functional or Physical Problems-----------------------------------------------> 
                     ...
                     <div class="row product-grid-3 border " id="DoHaveWindow" style="display:none;">
                        <h6 class="text-center mt-30">Do you have the following?</h6>
                           ...
                           <div class="col-lg-3 col-md-3 col-6 col-sm-4">
                              <div class="product-cart-wrap mb-10 mt-30" id="myDIVdo<?= $val['a_id'] ?>" onclick="setDoYouHaveVal(<?= $val['a_id'] ?>)">
                                 <div class="product-img-action-wrap">
                                    ...
                                    <img src="<?php echo base_url() ?>assets/uploads/accessories/<?= $val['a_image'] ?>" alt="<?= $val['a_title']; ?>" class="d-block rounded mx-auto img-fluid">
                                 </div>
                        ...
                        <div class="row">
                           <div class="col-3 d-none d-lg-block"></div>
                           <div class="col-lg-3 col-md-3 col-6 col-sm-4">  <span  class="btn btn-primary text-center hover-up mb-10 d-block rounded mx-auto" onclick="doyou_back();"><i class="fi-rs-arrow-left"></i>Back </span></div>
                           <div class="col-lg-3 col-md-3 col-6 col-sm-4">
                              <span  class="btn btn-success text-center hover-up mb-10 d-block rounded mx-auto" onclick="takeOrder();">Continue <i class="fi-rs-arrow-right"></i></span>
                           </div>
                        </div>
                     </div>
                     ...
                     <!----Product Age-----------------------------------> 
                           <div class="row product-grid-3 border border-radius-10" id="AgeWindow" style="display:none;">
                              <h6 class="text-center mt-30 mb-40">What is your mobile age?</h6>
                              <div class="row">
                                 <div class="col-lg-12 col-md-12 col-12 col-sm-4 mt-10">
                                       ...
                                       <?php if(!empty($p_age)){ ?>
                                          <?php foreach($p_age as $val){ ?>
                                            <div class="form-check form-check-inline radi-btn" >
                                          <input type="radio" class="form-check-input cb-age" name="mobile_age" data-id="<?php echo $val['age_id'] ?>" data-name="<?php echo $val['age_title'] ?>" value="Yes" id="btnradio_age_<?php echo $val['age_id'] ?>">
                              ...
                              <div class="row">
                                 <div class="col-3 d-none d-lg-block"></div>
                                 <div class="col-lg-3 col-md-3 col-6 col-sm-4 mt-40">  <span  class="btn btn-primary text-center hover-up mb-10 d-block rounded mx-auto" onclick="doyou_age_back();"><i class="fi-rs-arrow-left"></i>Back </span></div>
                                 <div class="col-lg-3 col-md-3 col-6 col-sm-4 mt-40">
                                    <span  class="btn btn-success text-center hover-up mb-10 d-block rounded mx-auto" onclick="validate_mobile_age()">Continue <i class="fi-rs-arrow-right"></i></span>
                                 </div>
                              </div>
                           </div>
                     <!----//Mobile Age---------------------------------> 
                  ...
                  <!--//lg-8-->
                  <div class="col-lg-4 ">
                     <div class="card border border-radius-10">
                        <div class="text-center clearfix">
                           <div class="image">
                              <img src="<?php echo base_url() ?>assets/uploads/model/<?= $model_data->m_image ?>" alt="<?= $model_data->m_name ?>" height="100" width="100">
                           </div>
                           <div class="content">
                     ...
                     <!-- Device Evaluation-->
                     <div class="sidebar-widget card border  mb-30 p-30 bg-grey">
                        ...
                        $('ul.dv_report_sopb').html("");
                           ...
                           $.ajax({
                            ...
                            success:function(response){
                              ...
                              $('ul.calc_body_sopb').append('<li class="body_sopb_type_'+calc_type+'">'+response.pq_value+'</li>')
                             // $('ul.calc_screen_cond').append('<li><input type="text" name="calc_age[]" class="age_type_'+calc_type+'" value="'+response.age_value+'"</li>')
                            }
                          });
                        }
                        ...
                        $('ul.dv_report_dopb').html("");
                           ...
                           $.ajax({
                            ...
                            success:function(response){
                              ...
                              $('ul.calc_body_dopb').append('<li class="body_dopb_type_'+calc_type+'">'+response.pq_value+'</li>')
                             // $('ul.calc_screen_cond').append('<li><input type="text" name="calc_age[]" class="age_type_'+calc_type+'" value="'+response.age_value+'"</li>')
                            }
                          });
                        }
                        ...
                        $('ul.dv_report_psbpc').html("");
                           ...
                           $.ajax({
                            ...
                            success:function(response){
                              ...
                              $('ul.calc_body_psbpc').append('<li class="body_psbpc_type_'+calc_type+'">'+response.pq_value+'</li>')
                             // $('ul.calc_screen_cond').append('<li><input type="text" name="calc_age[]" class="age_type_'+calc_type+'" value="'+response.age_value+'"</li>')
                            }
                          });
                        }
                        ...
                        $('ul.dv_report_bplc').html("");
                           ...
                           $.ajax({
                            ...
                            success:function(response){
                              ...
                              $('ul.calc_body_bplc').append('<li class="body_bplc_type_'+calc_type+'">'+response.pq_value+'</li>')
                             // $('ul.calc_screen_cond').append('<li><input type="text" name="calc_age[]" class="age_type_'+calc_type+'" value="'+response.age_value+'"</li>')
                            }
                          });
                        }
             ...
             $('.cb').click(function() {
               ...
               function flat_percent_value_calculation(){
                           ...
                           if(tot_val<0){
                              ...
                              document.getElementById("sorryWindow").style.display = "block";
                              return false;
                           }
               ...
               function validate_qsn_form(id){
                  if($('input[name="btnradio'+id+'"]:checked').length === 0) {
                     Swal.fire({
                           position: 'top',
                           icon: 'error',
            ...
            var order_id = <?= $order->id ?>;
                                    $.ajax({
                                       ...
                                       success: function (data) {
                                          ...
                                          position: 'top',
                                          icon: 'success',
                                          title: '<h4>Order Updated Successfully!</h4>',
                                          showConfirmButton: false,
                                          timer: 1500
                                          })
                                          location.replace(base_url+'executive/order_form/'+order_id)
                                       },
                                       error: function (data) {
...
<main class="page-content" id="mainCalcWindow" style="display:none;">
         <section class="mt-30 mb-50">
            <div class="container">
               <div class="row">
                  <div class="col-lg-7">
                  <div class="row border border-radius-10">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 mt-20">
                           <h5 class="font27-18 font-semi-bold"><?= $model_data->m_name; ?> (<?= $variant_data->variant_name; ?>)</h5>
                  ...
                  <!--//lg-8-->
                  <div class="col-lg-4 card border border-radius-10">
                        <div class="table-responsive order_table">
                                <table class="table">
                                    ...
                                    <tbody>
                                       <form id="editorderForm" method="post" action="<?= base_url() ?>admin/update_order_report">
                                       <input type="hidden" name="order_id" value="<?= $order->order_id; ?>">
                                       <input type="hidden" name="order_row_id" value="<?= $order->id; ?>">
                                        <tr>
                                            <td>
                                                <h5>Base Price</h5>
                                            </td>
                                        ...
                                        <tr>
                                            <td colspan="3">
                                               <button class="btn btn-success text-center hover-up mt-10 d-block rounded mx-auto" type="button" onclick="updateOrder();">Update Order <i class="fi-rs-arrow-right ml-5"></i></button>
                                             </td>
                                        </tr>
                                          </form>
                                    </tbody>
      ...
      <!--------we are sorry-------------------->
      <main class="page-content" id="sorryWindow" style="display:none;">
         <section class="mt-30 mb-50">
            <div class="container">
               <div class="row">
               <div class="col-lg-4 card border border-radius-10">.
