...
<html lang="en" class="light-theme">
        ...
        <script>
            ...
            $(document).ready(function (e) {
                $(".change_theme").on("click", function () {
                    ...
                    $.get("<?= base_url('executive/change_theme/') ?>" + type, function (data) {});
                })
    ...
    <body>
        ...
        <div class="wrapper">
                            ...
                            <li class="nav-item dropdown dropdown-large">
                                <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="<?= base_url() ?>#" data-bs-toggle="dropdown">
                                    <div class="user-setting d-flex align-items-center gap-1">
                                        ...
                                        <div class="user-name d-none d-sm-block"><?= $_SESSION['ex_staff_username'] ?></div>
                                    </div>
                                </a>
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="javascript:void(0);">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="ms-3">
                                                    <h6 class="mb-0 dropdown-user-name"><?= $_SESSION['ex_staff_username'] ?></h6>
            ...
            <!--end top header-->
            <?php $this->load->view('executive/sidebar'); ?>
            <div class="modal fade" id="change_user" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog modal-sm">
                    <div class="modal-content">
                        ...
                        <form action="<?= base_url('executive/change_password') ?>" method="post">
