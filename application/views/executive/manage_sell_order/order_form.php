            ...
            <!--end breadcrumb-->
            <form id="forms" method="post" action="<?= base_url('executive/submit_order') ?>">
              <div class="card">
                      ...
                      <div class="col-12 col-lg-3">
                        <div class="card border shadow-none bg-light radius-10">
                          <div class="card-body text-center">
                            ...
                            <hr><a href="<?= base_url('executive/edit_device_report/' . $order->id) ?>"><button type="button" class="btn btn-primary px-5 radius-30">Re-calculate Report</button></a>
                          </div>
                        </div>
                      </div>
                              ...
                              <h6>Device Details</h6>
                               ...
                               <?php if(!empty($json1['screen_condition'])){ ?>
                                 ...
                                 <?php }else{ ?>
                                    ...
                                    <li>No Line On Screen </li>
                                    <li>Screen Physical Condition Excellent </li>
                                  <?php } ?>
                               </ul>
                               <h6>Body Defects</h6>
                               <ul>
