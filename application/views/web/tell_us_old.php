               ...
               <div class="row">
                  <div class="col-lg-8">
                     ...
                     <!----//Queastion Yes No Window----------------------------------->  
                      ...
                      <!----Screen Condition-----------------------------------> 
                      <?php $scrncls = 'none';
                           if(empty($sc_qsn_dps) && empty($sc_qsn_vls) && empty($sc_qsn_spc)){
                              $scrncls ='none';
                           }?>
                      <div class="row product-grid-3 border border-radius-10" id="ScreenCondWindow" style="display:<?= $scrncls; ?>;">
                     ...
                     <?php $dyhf = 'none'; ?>
                     <?php if(empty($tellus_qsn) && empty($mst_qsn)){ 
                       $dyhf = 'flex';
                       } ?>
                     <?php if(!empty($p_accessories)){ ?>
                     <div class="row product-grid-3 border " id="DoHaveWindow" style="display:<?= $dyhf ?>;">
      ...
      <script>
         ...
         function ScreenCondWindow(){
            scroll_screen();
             ...
             <?php if(empty($sc_qsn_dps) && empty($sc_qsn_vls) && empty($sc_qsn_spc)){ ?>
          ...
          function BodyWindow(){
              ...
              <?php if(empty($bd_qsn_sopb) && empty($bd_qsn_dopb) && empty($bd_qsn_psbpc) && empty($bd_qsn_bplc)){ ?>
                document.getElementById("BodyCondWindow").style.display = "none";
              <?php }else{ ?>
          ...
          function body_problem(){
                              ...
                              if(valuebodychk=='Yes' && valuechk=='Yes'){
                                    ...
                                    <?php }else{ ?>
                                       document.getElementById("BodyCondWindow").style.display = "none";
                                       document.getElementById("ul-body").style.display = "none";
                                       <?php if(!empty($mst_qsn) && !empty($p_accessories)){ ?>
                                          ...
                                          <?php if(!empty($mst_qsn) && !empty($p_accessories)){ ?>
                                           ...
                                           <?php if(empty($mst_qsn) && !empty($p_accessories)){ ?>
                                              ...
                                              document.getElementById("TellWindow").style.display = "none";
                                           <?php } ?>               
                                       <?php if(empty($p_accessories) && empty($mst_qsn)){ ?>
                                          $(document).ready(function(){ document.getElementById("mainWindow").style.display = "none"; order_clack_window(); });
                                       <?php } ?>
                                       <?php } ?>
                              ...
                              if($('input[name="sopb"]:checked').length === 0) {
                                 ...
                                 <?php if(!empty($bd_qsn_dopb)){ ?>
                                    ...
                                    <?php } ?>
                                        ...
                                        <?php if(!empty($mst_qsn)){ ?>
                                           document.getElementById("TellWindow").style.display = "flex";
                                         <?php }else if(empty($p_accessories) && empty($mst_qsn)){ ?>
                                          $(document).ready(function(){ document.getElementById("mainWindow").style.display = "none"; order_clack_window(); });
                                         <?php } ?>
               ...
               $.ajax({
                        ...
                        success:function(response){
                           if(response.login=='1'){
                              ...
                              <?php if(empty($tellus_qsn) && empty($mst_qsn) && empty($p_accessories)){ ?>
                              document.getElementById("ctgo").style.display = "none";
                              <?php } ?>
...
<?php if(empty($tellus_qsn) && empty($mst_qsn) && empty($p_accessories)){ ?>
      <section class="mt-30 mb-50 text-center container" id="ctgo">
       <button type="button" class="btn btn-primary" onclick="order_clack_window();">Continoue to go order</button>
     </section>
      <script>$(document).ready(function(){ document.getElementById("mainWindow").style.display = "none"; order_clack_window(); });</script>
<?php } ?>
<?php if(empty($tellus_qsn) && !empty($mst_qsn)){ ?>
   <script>$(document).ready(function(){ document.getElementById("TellWindow").style.display = "flex"; });</script>
<?php } ?>
